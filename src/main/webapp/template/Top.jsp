	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">   
      ...
      <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
        ...
        <ul class="navbar-nav mr-3"><!--mr-3은 Navbar text와의 여백용-->
        	<!-- 세션 기반 인증 -->
        	<c:if test="${empty sessionScope.username}" var="isEmpty">
          <li class="nav-item">
            <a class="nav-link" href="<c:url value="/project/LoginPage.jsp" />">
          ...
          <li class="nav-item">
            <a class="nav-link " href="<c:url value="/myproject/List.ict" />">
          ...
          <c:if test="${pageContext.request.requestURI.endsWith('ListPage.jsp') and not empty username}">
          <li class="nav-item">
            <a class="nav-link " href="<c:url value="/myproject/MemberEdit.ict?username=${param.username}" />">
          ...
          <c:if test="${not isEmpty }">
          <li class="nav-item">
            <a class="nav-link " href="<c:url value="/myproject/Logout" />">
...
<c:if test="${pageContext.request.requestURI.endsWith('ListPage.jsp') and not empty username}">
    <li class="nav-item">
        <a  class="nav-link" href="<c:url value="/myproject/MDelete.ict?username=${sessionScope.username}"/>">
